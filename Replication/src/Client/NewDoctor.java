...
public class NewDoctor extends JPanel{
	...
	public String DoctorCreateValid(ManagerSession session) throws Exception{
		...
		{
			return session.getService().execute(",,"+Login.managerCode+",,2,,"+strFirstName+",,"+strLastName+
					",,"+strAddress+",,"+strPhoneNumber+",,"+strSpecialization+
					",,"+Login.managerCode+",,"+Login.managerID+",,");
		}
		return "create doctor not done";
	}
